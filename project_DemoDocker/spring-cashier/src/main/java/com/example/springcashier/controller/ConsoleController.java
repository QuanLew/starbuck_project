...
import com.example.springcashier.entity.Card;
import com.example.springcashier.entity.ConsoleCommand;
import com.example.springcashier.entity.Order;
import com.example.springcashier.entity.Ping;
...
public class ConsoleController {
    ...
    @GetMapping
    public String getAction(@ModelAttribute("console") ConsoleCommand command,
                            Model model) {
        return "console";
    }

    @PostMapping
    public String postAction(@Valid @ModelAttribute("console") ConsoleCommand command,
        ...
        if (action.equals("NEW ORDER")) {
            ...
            orderRequest.setDrink(orderRequest.setRandDrink()); ;
            orderRequest.setMilk(orderRequest.setRandMilk()) ;
            orderRequest.setSize(orderRequest.setRandSize());
